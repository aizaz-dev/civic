    ...
    <div className="flex flex-row w-full bg-[rgba(123,_200,_192,_0.1)] lg:px-[60px] px-[20px] lg:mb-[160px] mb-[80px]">
      <div className="flex flex-row  max-w-[1400px] mx-auto py-[60px]">
        <div className="flex flex-col gap-16 font-['Helvetica'] ">
          ...
          <div className="flex flex-row flex-wrap gap-24 lg:justify-center mx-auto my-auto w-full ">
            <div className="flex flex-row gap-5 ">
              ...
              <div className="flex flex-col font-['Quicksand'] ">
                <div className="text-center text-6xl font-['Helvetica'] font-bold leading-[66px] text-[#7bc8c0]">
                  10K
                </div>
            ...
            <div className="flex flex-row gap-5 ">
              ...
              <div className="flex flex-col gap-px font-['Quicksand'] ">
                <div className="lg:text-center text-6xl font-['Helvetica'] font-bold leading-[66px] text-[#7bc8c0]">
                  10K
                </div>
                <div className="lg:text-center opacity-50 text-lg font-semibold text-[#333333]">
            ...
            <div className="flex flex-row gap-5 ">
              ...
              <div className="flex flex-col gap-px w-2/3 font-['Quicksand'] ">
                ...
                <div
                  ...
                  className="lg:text-center opacity-50 text-lg font-semibold text-[#333333]"
                >
